...
1. [Introductions](Introductions.html)
2. R & RStudio Walkthrough
3. [Understanding R Principles](Principles.html)
4. [R Syntax](Syntax.html)
    a. Variables
    b. Operators
    c. Control Stuctures
    d. Functions
    e. Formulas, Specials, and R Uniqueness
5. [Data Structure in R](Syntax.html#2)
    a. Vectors & matrices
    b. Lists
    c. Data Frames
    d. S3, S4, R5, R6, & Others
    d. [Tibbles, Data Abstraction, & the Tidyverse](Tidyverse.html)
6. [Packages and GitHub](Packages.html#2)
    - [CRAN](https://cran.r-project.org)
    - [BioConductor](https://www.bioconductor.org/)\
    - [GitHub](https://github.com/search?q=language%3AR&type=Repositories&ref=advsearch&l=R&l=)
7. [Where to get help, your resources](Resources.html#2)
    * Help files
    ...
    * Other sites
8. [Getting Data](GettingData.html)
    * Data Sources
    * Reading Data
    * Saving Data
9. [Data Manipulations](DataWrangling.html)
    * Reshaping Data, Wide/Long, Nesting, Etc.
    * Subsetting/Filtering
    * Merging/Joining
10. [Summarization](DataWrangling.html)
11. [Graphics](Graphics.html)
    * Base Graphics
    * Grammar Based, `ggplot2`
12. [Analyses & Hypothesis Testing](Analysis.html)
