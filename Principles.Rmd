...
>     + is the main repository for contributed R Packages.
...
:::notes
Packages are essentially a collection of functions together in a
namespace.  We will talk about namespaces a little more later but
the important this to know here is how to find functions and
packages.
:::
